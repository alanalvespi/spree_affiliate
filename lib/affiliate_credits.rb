...
include SMS 
  ...
  if sender_credit_amount = SpreeAffiliate::Config["sender_credit_on_#{event}_amount".to_sym] and sender_credit_amount.to_f > 0 && event=="purchase"
      ...
      UserMailers.user_notification(recipient,sender,sender_credit_amount,"purchase","#{recipient.firstname} got Rs.#{sender_credit_amount} referral credits! Get yours too!").deliver
...
def notify_user(recipient, user, credit, event,sender_credit_amount)
  str = "It pays to have friends! Your friend #{recipient.firstname} just shopped, and we are delighted to credit Rs.#{sender_credit_amount} into your Styletag Referral Credits. <a href='www.styletag.com/invite'> Crave More, Invite More.</a> www.styletag.com/invite"
  Spree::Notification.create_notification(user.id,"<p>#{str}. <a href='/account#my-vouchers'>Click here to see your vouchers</a></p>")

  str = "You are destiny’s child! Your friend #{user.firstname} just got referral credits worth Rs.#{sender_credit_amount} because you just made your first purchase! Want some for yourself? <a href='www.styletag.com/invite'>Invite your friends now.</a> - www.styletag.com/invite"
...
def notify_event(recipient, user, credit, event,sender_credit_amount)
  str = "It's your lucky day! Your friend #{recipient.firstname} just joined Styletag & we have credited Rs.#{sender_credit_amount} into your Styletag Referral Credits. <a href='www.styletag.com/invite'>Hoard More, Invite More.</a> -www.styletag.com/invite"
  Spree::Notification.create_notification(user.id,"<p>#{str}. <a href='/account#my-vouchers'>Click here to see your vouchers</a></p>")

  str = "You just made #{user.firstname}'s day awesome! #{user.firstname} just got referral credits worth Rs.#{sender_credit_amount} because you just joined Styletag. <a href='www.styletag.com/invite'>Get Rs 1000 + 50 for every friend you INVITE.</a> - www.styletag.com/invite"
  Spree::Notification.create_notification(recipient.id,"<p>#{str}. <a href='/account#my-vouchers'>Click here to see your vouchers</a></p>")
end
                                                                                                                             ``
